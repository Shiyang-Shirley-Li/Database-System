...
{
    public partial class Team2LibraryContext : DbContext
    {
        public Team2LibraryContext()
        {
        }

        public Team2LibraryContext(DbContextOptions<Team2LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u1160160;Password=Lsy131496;Database=Team2Library");
            }
        }
